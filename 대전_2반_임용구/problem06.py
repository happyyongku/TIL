...
def calc_total(cart_list):
    total = 0         # 초기 total을 0으로설정
    for key in cart_list:    # cart_list를 순회, 키를 설정
        total += item_dict[key]   # total에 딕셔너리 내의 key의 값을 더하고 다시 할당
    return total  # total을 반환
...
cart1 = ['apple_pie','apple_pie', 'ice_cream', 'juice', 'gum', 'banana_milk']
